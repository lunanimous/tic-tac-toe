...
const LunaRoot = class {
    ...
    render() {
        return (h(Host, null, h("header", { class: "max-w-4xl mx-auto mt-6" }, h("div", { class: "text-center" }, h("a", { href: "https://lunanimous.github.io", class: "inline-flex p-2 text-2xl text-gray-600 font text-center" }, h("span", null, "Lunanimous"), h("svg", { fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", viewBox: "0 0 24 24", class: "w-8 h-8 ml-2 -mr-8 text-yellow-500" }, h("path", { d: "M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" }))))), h("section", { class: "max-w-4xl mx-auto mt-8" }, h("h2", { class: "text-center text-gray-800 text-4xl" }, GlobalConfig.appName)), this.isAuthenticated ? (h("main", { class: "max-w-2xl mx-auto mt-12" }, h("stencil-router", { historyType: 'hash' }, h("stencil-route-switch", { scrollTopOffset: 0 }, h("stencil-route", { url: "/", component: "luna-home", exact: true }), h("stencil-route", { url: "/game/:game", component: "luna-game" }))))) : (h("main", { class: "max-w-2xl mx-auto mt-12" }, h("div", { class: "text-center p-8" }, h("p", { class: "mb-6" }, "Login is required to play ", GlobalConfig.appName), h("button", { onClick: () => {
                this.login();
            }, type: "button", class: "button bg-indigo-700 hover:bg-indigo-800 text-white focus:outline-none focus:shadow-outline px-6 py-2" }, "Login")))), h("footer", { class: "max-w-2xl mx-auto text-center mt-16 border-t" }, h("p", { class: "text-gray-500 mt-8" }, "\u00A9 Lunanimous. All rights reserved."))));
    }
};
...
export { LunaRoot as luna_root, Route as stencil_route, RouteSwitch as stencil_route_switch, Router as stencil_router };
